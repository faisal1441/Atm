...
if (pinAnswer.Pin === myPin){
            ...
            let fastCashAmount = await inquirer.prompt([
                {
                    ...
                    type: "list",
                    choices: [20, 40, 60, 100] // Add your predefined amounts here
                }
            ]);
    ...
    //}
  */
// fast cash implentation 4 features figure different 
// concatenation ko template literal console.log("Your Remaining Balance is: " + myBalance);
// insufficient balance show if 
import inquirer from "inquirer";
let myBalance = 10000; // Dollar
let myPin = 1441;
let pinAnswer = await inquirer.prompt([
